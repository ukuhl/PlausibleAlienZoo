...
After performing three pilots with 10 users each to refine the experimental design, we recruited a total of 100 participants for final assessment, following an a priori sample size estimation~\citep{kumle_estimating_2021}.% Batch info neccesary? % report that users were excluded if the done it before?
