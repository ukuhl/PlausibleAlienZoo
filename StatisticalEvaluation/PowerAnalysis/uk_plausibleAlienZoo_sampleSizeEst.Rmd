...
# Where's the data
perf_source = list.files(path = "../../UserData", pattern="performance_PAZ_Pilot3.csv",full.names=TRUE)
rt_source = list.files(path = "../../UserData", pattern="reactionTime_PAZ_Pilot3.csv",full.names=TRUE)
survey_source = list.files(path = "../../UserData", pattern="survey_PAZ_Pilot3.csv",full.names=TRUE)
attention_source = list.files(path = "../../UserData", pattern="attentionCheck_PAZ_Pilot3.csv",full.names=TRUE)
